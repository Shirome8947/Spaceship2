...
Given un vaisseau spatial "" avec une capacité de "<capacité>" pilotes
When un pilote "" est assigné à ce vaisseau
...
Given un vaisseau spatial "" avec un niveau de carburant de "" unités
When il tente de voyager en consommant "" unités
...
Given un pilote "" déjà assigné au vaisseau ""
When on tente de l'assigner à un autre vaisseau ""
Then le système refuse avec le message ""
